...
type Tab = "conversations" | "summary";
          ...
          <>
            <div className="flex-1 overflow-y-auto space-y-6">
              <div className="bg-[#F3F3F3] rounded-[24px] p-6 ml-auto max-w-xl">
                help me with the best under graduate programs in cardiology in
                US and UK with differences
              </div>

              <div className="space-y-6">
                <div>
                  <h2 className="text-[20px] font-normal mb-4">
                    Key differences:
                  </h2>
                  <ul className="list-disc pl-8 space-y-2">
                    ...
                    <li className="text-[18px] leading-relaxed">
                      Structure: US requires separate undergraduate degree
                    ...
                    <li className="text-[18px] leading-relaxed">
                      Clinical exposure: UK programs integrate clinical
                      experience earlier
                    </li>
                    <li className="text-[18px] leading-relaxed">
                      Research opportunities: Both systems offer excellent
                      research but with different approaches
                    </li>
                  </ul>
                </div>
